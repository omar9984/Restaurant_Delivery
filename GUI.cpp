...
void GUI::DrawRestArea() const
{
	...
	pWind->DrawRectangle(RestStartX /*+ 150*/, RestStartY, RestEndX , RestEndY);
...
void GUI::DrawSingleOrder(Order* pO, int RegionCount) const       // It is a private function
{
	...
	REGION Region = pO->GetRegion()->GetRegionType();
...
void GUI::DrawOrders() const
{
	...
	{
		int orderRegion = OrdListForDrawing[i]->GetRegion()->GetRegionType();
